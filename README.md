[![Build Status](https://travis-ci.org/sbaboot/js-training.svg?branch=master)](https://travis-ci.org/nan-academy/js-training)
## Setup
First, [**fork**](https://github.com/sbaboot/js-training/fork?fragment=1) this repository.
